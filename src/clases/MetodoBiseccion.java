 ...
 * @author PABLO
 */
public class MetodoBiseccion extends Funcion {
    ...
    public void calcular(DefaultTableModel model) {
        ...
        double err;                             // margen de error
        double err2;                            // margen de error con raiz exacta
        int i = 1;                              // contador de las iteraciones
        ...
        do {
            ...
            xi = (a + b) / 2;                   // calculamos el punto medio
            ...
            fila[7] = i != 1 ? String.format("%.15f", err) : "No hay error";
            fila[8] = raiz == 0 ? "" : String.format("%.15f", err2);
